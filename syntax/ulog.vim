" Vim syntax file
" Language:         Unity log file
" Maintainer:       emi
" Latest Revision:  Fri Mar 17 01:38:12 PM CET 2023
" Based on log.vim 
...
syn match unityException   '[a-zA-Z]\+Exception:\?.\+'
syn match unityException   'Debug:LogError'
...
" Unity crap
" ---------------------------------------------------------------------------
syn match performanceLine       /\[Performance\].*/
...
syn keyword logLevelUnityException Exception
...
hi def link logLevelUnityException ErrorMsg
hi def link unityException ErrorMsg
hi def link performanceLine Comment
